...
use App\Http\Controllers\Admin\StoreTimingController;
...
Route::get('specials', [ServiceControllerForFront::class,'index'])->name('front.services');
...
Route::get('home_podcasts', [HomeController::class,'home_podcasts'])->name('front.home_podcasts');
...
/* Messages - Admin */
/* --------------------------------------- */
Route::get('admin/message', [ContactController::class,'messages'])->name('admin.messages.index');
Route::post('admin/message/option', [ContactController::class,'storeOption'])->name('admin.message.option.store');
Route::delete('admin/option/{id}', [ContactController::class,'deleteOption'])->name('admin.message.option.delete');


/* --------------------------------------- */
/* Order Shippings - Admin */
/* --------------------------------------- */
Route::resource('admin/order_shipping', OrderShippingController::class);
...
/* Podcast - Admin */
/* --------------------------------------- */
Route::get('admin/podcast/view', [PodcastController::class,'index'])->name('admin.podcast.index');
Route::get('admin/podcast/create', [PodcastController::class,'create'])->name('admin.podcast.create');
Route::post('admin/podcast/store', [PodcastController::class,'store'])->name('admin.podcast.store');
Route::get('admin/podcast/delete/{id}', [PodcastController::class,'destroy']);
Route::get('admin/podcast/edit/{id}', [PodcastController::class,'edit']);
Route::post('admin/podcast/update/{id}', [PodcastController::class,'update']);
...
Route::post('admin/customers/send-email-action', [SubscriberController::class,'send_customers_email_action'])->name('admin.customers.send_email_action');
Route::post('admin/customers/send-email-action_excel', [SubscriberController::class,'send_customers_email_action_excel'])->name('admin.customers.send_email_action.excel');
Route::post('admin/customers/send-email-action_landing', [SubscriberController::class,'send_customers_email_action_landing'])->name('admin.customers.send_email_action.landing');


/* --------------------------------------- */
/* SMS/Whatsapp - Admin */
/* --------------------------------------- */
Route::post('admin/customers/send-sms-action', [TwillioController::class,'send_customers_sms_action'])->name('admin.customers.send_sms_action');
Route::post('admin/customers/send-sms-action-landing', [TwillioController::class,'send_customers_sms_action_landing'])->name('admin.customers.send_sms_action_landing');
Route::post('admin/customers/send-sms-action-excel', [TwillioController::class,'send_customers_sms_action_excel'])->name('admin.customers.send_sms_action.excel');
...
/* --------------------------------------- */
/* Excel Contacts - Admin */
/* --------------------------------------- */
Route::get('import_excel_contacts', [CustomerController::class,'import_excel_contacts'])->name('admin.excel.import');
...
/* --------------------------------------- */
/* Manual Messages / Mail - Admin */
/* --------------------------------------- */
Route::get('admin_manual_messages', [TwillioController::class,'admin_manual_messages'])->name('admin.manual.messages');
Route::post('admin/manual_email', [SubscriberController::class,'admin_manual_email'])->name('admin.manual.email');
Route::post('admin/manual_sms', [TwillioController::class,'admin_manual_sms'])->name('admin.manual.sms');
Route::post('admin/manual_whatsapp', [TwillioController::class,'admin_manual_whatsapp'])->name('admin.manual.whatsapp');
...
Route::prefix('admin')->name('admin.')->group(function() {
    Route::resource('product_category', ProductCategoryControllerForAdmin::class)->except(['create', 'show']);
});
...
Route::post('admin/customer/send-message', [CustomerController::class,'send_message'])->name('admin.customer.sendmessage');
...
/* Super Admin */
/* --------------------------------------- */
Route::get('superadmin/message/limit', [GeneralSettingController::class,'getLimits'])->name('superadmin.message.limit');
Route::post('superadmin/message/limit', [GeneralSettingController::class,'setLimits'])->name('superadmin.message.limit.set');

/* --------------------------------------- */
/* File Manager - Admin */
/* --------------------------------------- */
Route::get('admin/file-manager', [FileManagerController::class, 'index'])->name('file-manager.index');
Route::get('admin/file-manager/download/{name}', [FileManagerController::class, 'download'])->name('file-manager.download');
Route::get('admin/file-manager/remove/{id}/{name}', [FileManagerController::class, 'remove'])->name('file-manager.remove');
Route::post('admin/file-manager/upload', [FileManagerController::class, 'upload'])->name('file-manager.upload');
Route::post('admin/file-manager/create-folder', [FileManagerController::class, 'createFolder'])->name('file-manager.create-folder');

/* --------------------------------------- */
/* File Manager / Signature Pad - Admin */
/* --------------------------------------- */
Route::get('admin/signature-pad', [FileManagerController::class, 'signaturePad'])->name('signature-pad.draw');
...
Route::post('admin/invoice-builder/thermal_invoice', [InvoiceController::class, 'thermal_invoice'])->name('invoice-builder.thermal_invoice');
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin', 'as'=> 'admin.'], function () {
    ...
    Route::post('group-contacts', [GroupController::class, 'store_contact'])->name('group.contacts.store');
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin', 'as'=> 'admin.'], function () {
    ...
    Route::post('offering/update-status', [OfferingController::class, 'updateStatus'])->name('offering.update_status');
    Route::get('offering/check-new-orders', [OfferingController::class, 'checkNewOrders'])->name('offering.check_new_orders');
...
Route::get('offering/thank', [ProductControllerForFront::class,'thank_offering'])->name('front.thank_offering');
Route::get('offering/finish', [ProductControllerForFront::class,'finish_offering']);
Route::post('offering/avail/update-tip', [ProductControllerForFront::class, 'availUpdate'])->name('front.avail_update_tip');
Route::post('offering/avail/coupon', [ProductControllerForFront::class, 'availCoupon'])->name('front.avail_coupon');


Route::get('admin/timings/edit', [StoreTimingController::class, 'edit'])->name('admin.timings.edit')->middleware('admin');
Route::put('admin/timings/update', [StoreTimingController::class, 'update'])->name('admin.timings.update')->middleware('admin');
Route::put('admin/shop_status_color/update', [StoreTimingController::class, 'update_shop_status_color'])->name('admin.shop_status_color.update')->middleware('admin');


// Hiring - Front & Admin
Route::get('hire', [HireController::class, 'index'])->name('front.hire');
Route::post('hire/add-candidate', [HireController::class, 'add_candidate'])->name('front.hire.add_candidate');
Route::get('admin/candidate', [CandidateController::class, 'index'])->name('admin.candidate');
