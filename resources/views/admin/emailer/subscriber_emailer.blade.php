...
<h1 class="h3 mb-3 text-gray-800">Send Email to Subscribers </h1>
    <div class="card shadow mb-4">
        ...
        <a href="#"  data-toggle="modal" class="btn btn-primary btn-sm btn-block" data-target="#send_email">Send Email to Subscribers</a>
                ...
                <table class="table table-bordered" id="customers-table" width="100%" cellspacing="0">
                    ...
                    @foreach($subscribers as $row)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                     <form action="{{ url('subscriber_delete/'. $row->id) }}" method="post">
                                         @csrf
                                         @method('DELETE')
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('admin.subscriber.send_email') }}" method="post">
                  @csrf
