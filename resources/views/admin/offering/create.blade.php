...
@section('admin_content')
    ...
    <form action="{{ route('admin.offering.store') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="1" step="0.01" name="regular_rate" class="form-control"
                        value="{{ old('regular_rate') }}">
                </div>
                <div class="form-group">
                    <label for="">Appointment Rate *</label>
                    <input type="number" min="1" step="0.01" name="appointed_rate" class="form-control"
                        value="{{ old('appointed_rate') }}">
                </div>
                <div class="form-group">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="is_active" id="rr1" checked>
