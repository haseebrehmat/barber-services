...
@section('admin_content')
    ...
    <form action="{{ url('landingpages_update') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="form-group d-flex align-items-center">
                    <label for="text">Landing Page Name</label>
                    <textarea name="lpc_name" id="text" class="form-control form-control-sm mx-3 col-md-6">{{ $general_setting->lpc_name }}
                </textarea>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group d-flex align-items-center">
                            ...
                            <div class="form-group mx-4">
                                ...
                                <div class="upload-left-div">
                                    <label for="">Change Left Side Background Image Width in %</label>
                                    <div>
                                        <input type="number" class="form-control" name="lpc_left_bg_width" value="{{$general_setting->lpc_left_bg_width}}">
                                    </div>
                                </div>

                                <div class="upload-left-div">
                                    <label for="">Change Left Side Background Image Height in %</label>
                                    <div>
                                        <input type="number" class="form-control" name="lpc_left_bg_height" value="{{$general_setting->lpc_left_bg_height}}">
                                    </div>
                                </div>
